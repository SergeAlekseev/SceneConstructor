...
namespace SceneConstructor
{
	partial class EditorScene
	{
		...
		private void InitializeComponent()
		{
			...
			this.listView1.Size = new System.Drawing.Size(232, 381);
			this.listView1.TabIndex = 8;
			this.listView1.UseCompatibleStateImageBehavior = false;
			// 
			// bSelectJS
			// 
			this.bSelectJS.Location = new System.Drawing.Point(258, 418);
			this.bSelectJS.Name = "bSelectJS";
			this.bSelectJS.Size = new System.Drawing.Size(127, 23);
			this.bSelectJS.TabIndex = 9;
			this.bSelectJS.Text = "Добавить метку";
			...
			this.button1.Text = "Привязать к метке";
			...
			this.listView2.Location = new System.Drawing.Point(258, 31);
			this.listView2.Name = "listView2";
			this.listView2.Size = new System.Drawing.Size(232, 381);
			...
			this.label2.Text = "Действия объекта";
			// 
			// button2
			// 
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(507, 60);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(507, 373);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(146, 23);
			this.button5.TabIndex = 17;
			this.button5.Text = "Предпросмотр";
			this.button5.UseVisualStyleBackColor = true;
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(507, 418);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(146, 23);
			this.button6.TabIndex = 18;
			this.button6.Text = "Web редактор";
			this.button6.UseVisualStyleBackColor = true;
			// 
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(507, 155);
			...
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(507, 252);
